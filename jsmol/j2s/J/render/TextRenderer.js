...
var h = Clazz.doubleToInt ((text.lineHeight) / 3);
var y = Clazz.floatToInt (temp[1]) - i;
g3d.fillTextRect (x1, y - Clazz.doubleToInt (h / 2) - 2 - ia, z, text.zSlab, x2 - x1, 2 * ia);
g3d.fillTextRect (x1, y - Clazz.doubleToInt (h * 3 / 2), z, text.zSlab, 2 * ia, Clazz.doubleToInt (h * 3 / 2));
g3d.fillTextRect (x2, y - Clazz.doubleToInt (h * 3 / 2), z, text.zSlab, 2 * ia, Clazz.doubleToInt (h * 3 / 2));
